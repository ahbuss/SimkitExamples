 ...
 * @author ahbuss
 */
public class TransferLineWithBlocking extends SimEntityBase {
    ...
    public TransferLineWithBlocking() {

    }

    public TransferLineWithBlocking(int numberStations, int[] totalNumberMachines,
