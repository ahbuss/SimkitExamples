...
public class MultiStat implements PropertyChangeListener {
    ...
    private static final Logger LOGGER = Logger.getLogger(MultiStat.class.getName());
    ...
    public MultiStat(String simulationID, double pmss, Statement statement) {
